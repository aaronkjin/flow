...
- **Visual feedback**: the focused/hovered item must have a clear but subtle visual indicator (e.g., `bg-muted/50` background + a thin left accent border)
...
- **Focused row visual**: `bg-muted/40` background (replaces hover state)
...
- **Focused row visual**: `bg-muted/40` background
...
- **Focused item visual**: `bg-muted/40` background + subtle left border accent
